...
type AzureSdConfig struct {
	...
	// The client secret.
	ClientSecret common.Secret `json:"client_secret,omitempty" yaml:"client_secret,omitempty"`
...
type ConsulSdConfig struct {
	...
	Password   common.Secret `json:"password,omitempty" yaml:"password,omitempty"`
...
type EC2SdConfig struct {
	...
	SecretKey common.Secret `json:"secret_key,omitempty" yaml:"secret_key,omitempty"`
